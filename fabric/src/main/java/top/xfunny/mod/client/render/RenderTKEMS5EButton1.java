...
import top.xfunny.mod.block.TKEMS5EButton1;
...
public class RenderTKEMS5EButton1 extends BlockEntityRenderer<TKEMS5EButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderTKEMS5EButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(TKEMS5EButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            TKEMS5EButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
