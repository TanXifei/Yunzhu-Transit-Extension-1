...
import top.xfunny.mod.block.MitsubishiGPS3Button1;
...
public class RenderMitsubishiGPS3Button1 extends BlockEntityRenderer<MitsubishiGPS3Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_1_light.png");

    public RenderMitsubishiGPS3Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiGPS3Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiGPS3Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_gps3_button_1_display_%d", i));
