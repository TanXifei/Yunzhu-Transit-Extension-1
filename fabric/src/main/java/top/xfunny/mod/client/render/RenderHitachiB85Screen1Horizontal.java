...
public class RenderHitachiB85Screen1Horizontal<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderHitachiB85Screen1Horizontal(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiB85Screen1HorizontalEven.LiftCheck(trackPosition, (floorIndex, lift) -> sortedPositionsAndLifts.add(new ObjectObjectImmutablePair<>(trackPosition, lift)));
        });
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFCC0000);
                liftFloorDisplayView.setTextureId(String.format("hitachi_b85_screen_1_horizontal_display_%d_%s", i, blockEntity.getPos2().asLong()))
;
                ...
                liftFloorDisplayView.setMargin(1.875F/16, 5.875F / 16, 0, 0);
                ...
                liftArrowView_left.setMargin(-3.125F/16, 6.8F / 16, 0, 0);
