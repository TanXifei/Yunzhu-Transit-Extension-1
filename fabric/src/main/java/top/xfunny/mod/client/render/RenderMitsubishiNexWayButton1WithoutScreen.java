...
public class RenderMitsubishiNexWayButton1WithoutScreen extends BlockEntityRenderer<MitsubishiNexWayButton1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiNexWayButton1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiNexWayButton1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
