...
public class RenderSchindlerFIGSButton1 extends BlockEntityRenderer<SchindlerFIGSButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerFIGSButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerFIGSButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
