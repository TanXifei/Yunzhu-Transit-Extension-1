...
import top.xfunny.mod.block.ToshibaLantern1Even;
...
public class RenderToshibaLantern1<T extends LiftButtonsBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderToshibaLantern1(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        screenLayout.setMargin(0, 0, 1.4F / 16, 0);
        ...
        lanternGroupLeft.setMargin(0, 0, 1.4F / 16, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ToshibaLantern1Even.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
