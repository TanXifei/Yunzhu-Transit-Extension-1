...
import top.xfunny.mod.block.MitsubishiButtonSHT;
...
public class RenderMitsubishiButtonSHT extends BlockEntityRenderer<MitsubishiButtonSHT.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiButtonSHT(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiButtonSHT.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiButtonSHT.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_button_sht_display_%d", i));
