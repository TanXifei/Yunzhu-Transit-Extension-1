...
import top.xfunny.mod.block.ThyssenKruppMS3EButton1;
...
public class RenderThyssenKruppMS3EButton1 extends BlockEntityRenderer<ThyssenKruppMS3EButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderThyssenKruppMS3EButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ThyssenKruppMS3EButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ThyssenKruppMS3EButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("thyssenkrupp_ms3e_button_1_display_%d", i));
