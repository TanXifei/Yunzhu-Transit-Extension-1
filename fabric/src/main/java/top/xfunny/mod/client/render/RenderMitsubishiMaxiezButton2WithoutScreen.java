...
import top.xfunny.mod.block.MitsubishiMaxiezButton2WithoutScreen;
...
public class RenderMitsubishiMaxiezButton2WithoutScreen extends BlockEntityRenderer<MitsubishiMaxiezButton2WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMaxiezButton2WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton2WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMaxiezButton2WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
