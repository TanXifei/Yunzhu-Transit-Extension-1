...
import top.xfunny.mod.block.HitachiVIB681Button;
...
public class RenderHitachiVIB681Button extends BlockEntityRenderer<HitachiVIB681Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB681Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB681Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB681Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.5F,
                        0xFFDEF6FF);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_681_display_%d", i));
                ...
                liftArrowView.setDimension(1F / 16, 489, 468);
                liftArrowView.setMargin(0, 0.37F / 16, 0, 0);
