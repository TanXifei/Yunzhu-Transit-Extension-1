...
public class RenderHitachiB89Screen1Vertical<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderHitachiB89Screen1Vertical(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setPosition(isOdd ? -0.284375F : -0.784375F, 0.85F);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiB85Screen1VerticalEven.LiftCheck(trackPosition, (floorIndex, lift) -> sortedPositionsAndLifts.add(new ObjectObjectImmutablePair<>(trackPosition, lift)));
        });
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFCC0000);
                liftFloorDisplayView.setTextureId(String.format("hitachi_b89_screen_1_vertical_display_%d_%s", i, blockEntity.getPos2().asLong()))
;
