...
import top.xfunny.mod.block.HitachiVIB191Button;
...
public class RenderHitachiVIB191Button extends BlockEntityRenderer<HitachiVIB191Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/yl_gw.png");
    private static final Identifier LIGHT_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/yl_gw_up_light.png");
    private static final Identifier BUTTON_DOWN_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/yl_gw.png");
    private static final Identifier LIGHT_DOWN_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/yl_gw_down_light.png");
    private static final BooleanProperty UNLOCKED = BooleanProperty.of("unlocked");

    public RenderHitachiVIB191Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB191Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB191Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.5F,
                        0xFFDEF6FF);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_191_display_%d",i));
