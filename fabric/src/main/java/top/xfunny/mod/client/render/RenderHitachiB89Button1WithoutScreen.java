...
import top.xfunny.mod.block.HitachiB89Button1WithoutScreen;
...
public class RenderHitachiB89Button1WithoutScreen extends BlockEntityRenderer<HitachiB89Button1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiB89Button1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiB89Button1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiB89Button1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
