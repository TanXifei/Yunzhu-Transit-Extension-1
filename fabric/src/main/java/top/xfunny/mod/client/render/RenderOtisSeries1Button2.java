...
import top.xfunny.mod.block.OtisSeries1Button2;
...
public class RenderOtisSeries1Button2 extends BlockEntityRenderer<OtisSeries1Button2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    private final Identifier BUTTON_ARROW_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/otis_s1_arrow.png");
    private final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/otis_s1_button.png");
    private final int HOVER_COLOR = 0xFFFFFFFF;
    private final int PRESSED_COLOR = 0xFFFFCB3B;

    public RenderOtisSeries1Button2(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(OtisSeries1Button2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonContainer.setMargin(0, 0, 0.4F / 16, 0.4F / 16);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            OtisSeries1Button2.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        backgroundLayout.addChild(buttonContainer);
        parentLayout.render();
    }
}