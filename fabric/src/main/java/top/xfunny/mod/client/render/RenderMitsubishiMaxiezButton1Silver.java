...
import top.xfunny.mod.block.MitsubishiMaxiezButton1Silver;
...
public class RenderMitsubishiMaxiezButton1Silver extends BlockEntityRenderer<MitsubishiMaxiezButton1Silver.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMaxiezButton1Silver(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton1Silver.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
