...
import top.xfunny.mod.block.SchindlerRSeriesRoundButton;
...
public class RenderSchindlerRSeriesRoundButton extends BlockEntityRenderer<SchindlerRSeriesRoundButton.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private final int HOVER_COLOR = 0xFFFF9999;
    private final int PRESSED_COLOR = 0xFFFF0000;
    private final Identifier BUTTON_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/schindler_r_series_button_round.png");
    private final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/schindler_r_series_button_round_light.png");
    private final Identifier LOGO = new Identifier(Init.MOD_ID, "textures/block/schindler_m_series_logo_2.png");

    public RenderSchindlerRSeriesRoundButton(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerRSeriesRoundButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonUp.setDimension(0.75F / 16);
        ...
        buttonUpLight.setDimension(0.75F / 16);
        ...
        buttonUpLight.setButtonSound("schindler_r_series_button_1");
        ...
        buttonDownLight.setDimension(0.75F / 16);
        ...
        buttonDownLight.setButtonSound("schindler_r_series_button_1");
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerRSeriesRoundButton.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
