...
import top.xfunny.mod.block.HitachiB89Button2;
...
public class RenderHitachiB89Button2 extends BlockEntityRenderer<HitachiB89Button2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/hitachi_b89_button.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/hitachi_b89_button_light.png");
    ...
    public RenderHitachiB89Button2(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiB89Button2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonDownLight.setFlip(true, true);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiB89Button2.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("hitachi_b85_screen_2_display_%d_%s", i, blockEntity.getPos2().asLong()));
