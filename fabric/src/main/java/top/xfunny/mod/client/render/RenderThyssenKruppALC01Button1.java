...
import top.xfunny.mod.block.ThyssenKruppALC01Button1;
...
public class RenderThyssenKruppALC01Button1 extends BlockEntityRenderer<ThyssenKruppALC01Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderThyssenKruppALC01Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ThyssenKruppALC01Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        screenLayout.setMargin(0, 0.8F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ThyssenKruppALC01Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("thyssenkrupp_alc01_button_1_display_%d", i));
                liftFloorDisplayView.setWidth(1.2F / 16);
                liftFloorDisplayView.setHeight(1.7F / 16);

                liftFloorDisplayView.setMargin(0.475F / 16, -0.175F / 16, 0.325F / 16, 0);
