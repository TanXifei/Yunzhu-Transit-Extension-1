...
import top.xfunny.mod.block.HitachiVIB325Button;
...
public class RenderHitachiVIB325Button extends BlockEntityRenderer<HitachiVIB325Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB325Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB325Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB325Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
