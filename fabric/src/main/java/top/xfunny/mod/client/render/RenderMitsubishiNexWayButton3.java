...
import top.xfunny.mod.block.MitsubishiNexWayButton3;
...
public class RenderMitsubishiNexWayButton3 extends BlockEntityRenderer<MitsubishiNexWayButton3.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiNexWayButton3(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiNexWayButton3.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiNexWayButton3.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_nexway_button_3_display_%d",i));
