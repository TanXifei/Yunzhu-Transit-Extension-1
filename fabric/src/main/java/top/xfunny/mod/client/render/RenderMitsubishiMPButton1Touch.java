...
import top.xfunny.mod.block.MitsubishiMPButton1Touch;
...
public class RenderMitsubishiMPButton1Touch extends BlockEntityRenderer<MitsubishiMPButton1Touch.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFFCDA081;
    private static final int PRESSED_COLOR = 0xFFEFC2A3;
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_mp_button_1_touch.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_mp_button_1_touch_light.png");

    public RenderMitsubishiMPButton1Touch(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMPButton1Touch.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMPButton1Touch.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
