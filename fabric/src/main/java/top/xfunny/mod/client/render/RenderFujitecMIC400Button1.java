...
public class RenderFujitecMIC400Button1 extends BlockEntityRenderer<FujitecMIC400Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderFujitecMIC400Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(FujitecMIC400Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            FujitecMIC400Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("fujitec_mic400_button_1_display_%d", i));
