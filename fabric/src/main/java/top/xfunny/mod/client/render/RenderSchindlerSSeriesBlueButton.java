...
import top.xfunny.mod.block.SchindlerSSeriesBlueButton;
...
public class RenderSchindlerSSeriesBlueButton extends BlockEntityRenderer<SchindlerSSeriesBlueButton.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF90FF90;
    private static final int PRESSED_COLOR = 0xFF00FF00;
    private static final int DEFAULT_COLOR = 0xFF000000;
    private final Identifier BUTTON_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/schindler_s_series_blue_button.png");
    ...
    public RenderSchindlerSSeriesBlueButton(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerSSeriesBlueButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerSSeriesBlueButton.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
