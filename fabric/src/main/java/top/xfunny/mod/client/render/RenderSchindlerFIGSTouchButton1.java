...
public class RenderSchindlerFIGSTouchButton1 extends BlockEntityRenderer<SchindlerFIGSTouchButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF990000;
    private static final int PRESSED_COLOR = 0xFFFF0000;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_arrow_4.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_touch_button_1.png");
    private static final Identifier BUTTON_LINE_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_touch_button_1_line.png");


    public RenderSchindlerFIGSTouchButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerFIGSTouchButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSTouchButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
...
;
        ...
        if (buttonDescriptor.hasDownButton()) {
            if (buttonDescriptor.hasUpButton()) {
                buttonContainer.addChild(buttonLine);
                downButtonGroup.setMargin(0, 0.4F / 16, 0, 0);
            }
