...
public class RenderToshibaScreen1<T extends LiftButtonsBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private static final int PRESSED_COLOR_UP = 0xFF33CC33;
    private static final int PRESSED_COLOR_DOWN = 0xFFCC3333;
    private static final int DEFAULT_COLOR = 0xFFFFFFFF;
    private static final Identifier BUTTON_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/white.png");
    private static final Identifier ARROW_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/toshiba_lantern_1_arrow.png");
    private final boolean isOdd;

    public RenderToshibaScreen1(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setPosition(isOdd ? -7.75F / 16 : -15.75F / 16, 9.75F / 16);
        ...
        screenLayout.setMargin(0, 0, 1.2F / 16, 0);
        ...
        lanternGroupLeft.setMargin(0, 0, 1.2F / 16, 0);
        ...
        downLanternLeft.setPressedColor(PRESSED_COLOR_DOWN);
        ...
        downLanternRight.setPressedColor(PRESSED_COLOR_DOWN);
        ...
        upLanternLeft.setPressedColor(PRESSED_COLOR_UP);
        ...
        upLanternRight.setPressedColor(PRESSED_COLOR_UP);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ToshibaScreen1Even.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
                    ...
                    switch (pressedButtonDirection) {
                        case DOWN:
                            ...
                            if (!blockEntity.lastDownActive) {
                                InitClient.REGISTRY_CLIENT.sendPacketToServer(new PacketLanternSoundInstruction(blockPos, "toshiba_lantern_1_down"));
                        ...
                        case UP:
                            ...
                            if (!blockEntity.lastDownActive) {
                                InitClient.REGISTRY_CLIENT.sendPacketToServer(new PacketLanternSoundInstruction(blockPos, "toshiba_lantern_1_up"));
                                blockEntity.lastDownActive = true;
                                blockEntity.lastUpActive = true;
                            }
                            break;
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("toshiba_screen_1_display_%d_%s", i, blockEntity.getPos2().asLong()));//字体贴图id，不能与其他显示屏的重复
