...
import top.xfunny.mod.block.HitachiVIB663Button;
...
public class RenderHitachiVIB663Button extends BlockEntityRenderer<HitachiVIB663Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/tl_mo_up.png");
    private static final Identifier LIGHT_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/tl_mo_up_light.png");
    private static final Identifier BUTTON_DOWN_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/tl_mo_down.png");
    private static final Identifier LIGHT_DOWN_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/tl_mo_down_light.png");
    private static final BooleanProperty UNLOCKED = BooleanProperty.of("unlocked");

    public RenderHitachiVIB663Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB663Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB663Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFFF4800);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_663_display_%d_%s", i, blockEntity.getPos2().asLong()));
