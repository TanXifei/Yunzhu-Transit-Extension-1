...
public class RenderShanghaiMitsubishiLehy3Button3LCD extends BlockEntityRenderer<ShanghaiMitsubishiLehy3Button3LCD.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFFCCCCCC;
    private static final int PRESSED_COLOR = 0xFFFFFFFF;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/shanghai_mitsubishi_lehy_3_arrow_2.png");
    ...
    @Override
    public void render(ShanghaiMitsubishiLehy3Button3LCD.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        storedMatrixTransformations1.add(graphicsHolder -> {
            ...
            graphicsHolder.translate(0, 0, 7.75F / 16 - SMALL_OFFSET / 2);
        });
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ShanghaiMitsubishiLehy3Button3LCD.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("shanghai_mitsubishi_lehy_3_button_3_lcd_display_%d", i))
;
