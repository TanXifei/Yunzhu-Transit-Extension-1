...
import top.xfunny.mod.block.MitsubishiMaxiezButton3LCD;
...
public class RenderMitsubishiMaxiezButton3LCD extends BlockEntityRenderer<MitsubishiMaxiezButton3LCD.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMaxiezButton3LCD(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton3LCD.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMaxiezButton3LCD.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
