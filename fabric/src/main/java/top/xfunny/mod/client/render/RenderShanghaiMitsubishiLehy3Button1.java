...
import top.xfunny.mod.block.ShanghaiMitsubishiLehy3Button1;
...
public class RenderShanghaiMitsubishiLehy3Button1 extends BlockEntityRenderer<ShanghaiMitsubishiLehy3Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFFBCA27C;
    private static final int PRESSED_COLOR = 0xFFEFD5AF;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/shanghai_mitsubishi_lehy_3_arrow_1.png");
    ...
    public RenderShanghaiMitsubishiLehy3Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ShanghaiMitsubishiLehy3Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ShanghaiMitsubishiLehy3Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        FontList.instance.getFont(floorNumber.equals("1") ? "shanghai_mitsubishi_segmented_1_sp" : "shanghai_mitsubishi_segmented_1"),
                        8.25F,
                        0xFFE77831);
