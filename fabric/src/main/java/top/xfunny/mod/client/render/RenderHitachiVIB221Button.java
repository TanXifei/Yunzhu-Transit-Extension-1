...
public class RenderHitachiVIB221Button extends BlockEntityRenderer<HitachiVIB221Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB221Button(Argument dispatcher) {
        super(dispatcher);
    }
    ...
    public void render(HitachiVIB221Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_221_display_%d", i));
