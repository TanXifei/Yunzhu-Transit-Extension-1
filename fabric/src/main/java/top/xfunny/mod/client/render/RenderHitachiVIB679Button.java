...
import top.xfunny.mod.block.HitachiVIB679Button;
...
public class RenderHitachiVIB679Button extends BlockEntityRenderer<HitachiVIB679Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB679Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB679Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB679Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.25F,
                        0xFFDEF6FF);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_679_display_%d", i));
                liftFloorDisplayView.setWidth(1.5F / 16);
                liftFloorDisplayView.setHeight(1.7F / 16);
                liftFloorDisplayView.setLetterSpacing(5);
                liftFloorDisplayView.setMargin(0, -0.25F/ 16, 0.25F/16, 0);
                ...
                liftArrowView.setMargin(0.125F / 16, 1.12F / 16, 0, 0);
