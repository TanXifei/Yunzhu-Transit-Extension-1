...
import top.xfunny.mod.block.HitachiVIB322Button;
...
public class RenderHitachiVIB322Button extends BlockEntityRenderer<HitachiVIB322Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    @Override
    public void render(HitachiVIB322Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB322Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
