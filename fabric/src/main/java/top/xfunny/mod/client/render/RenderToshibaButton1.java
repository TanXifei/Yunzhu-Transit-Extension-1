...
import top.xfunny.mod.block.ToshibaButton1;
...
public class RenderToshibaButton1 extends BlockEntityRenderer<ToshibaButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF84B91B;
    private static final int PRESSED_COLOR = 0xFFA6DB3D;
    private static final int DEFAULT_COLOR = 0xFFFFFFFF;
    private static final Identifier BUTTON_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/toshiba_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/toshiba_button_1_light.png");

    public RenderToshibaButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ToshibaButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ToshibaButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
