...
import top.xfunny.mod.block.MitsubishiGPS3Button2;
...
public class RenderMitsubishiGPS3Button2 extends BlockEntityRenderer<MitsubishiGPS3Button2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_2_arrow.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_gps3_button_2.png");

    public RenderMitsubishiGPS3Button2(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiGPS3Button2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiGPS3Button2.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
