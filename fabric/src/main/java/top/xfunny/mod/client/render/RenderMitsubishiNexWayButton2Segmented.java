...
import top.xfunny.mod.block.MitsubishiNexWayButton2Segmented;
...
public class RenderMitsubishiNexWayButton2Segmented extends BlockEntityRenderer<MitsubishiNexWayButton2Segmented.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiNexWayButton2Segmented(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiNexWayButton2Segmented.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiNexWayButton2Segmented.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_nexway_button_2_segmented_display_%d", i));
                liftFloorDisplayView.setWidth(1.4F / 16);
                liftFloorDisplayView.setHeight(1.7F / 16);
                liftFloorDisplayView.setMargin(-0.2F / 16, 0, 0.3F / 16, 0);
