...
import top.xfunny.mod.block.MitsubishiMaxiezButton3;
...
public class RenderMitsubishiMaxiezButton3 extends BlockEntityRenderer<MitsubishiMaxiezButton3.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMaxiezButton3(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton3.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMaxiezButton3.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_maxiez_button_3_display_%d_%s", i, blockEntity.getPos2().asLong()));
