...
import top.xfunny.mod.block.HitachiVIB192Button;
...
public class RenderHitachiVIB192Button extends BlockEntityRenderer<HitachiVIB192Button.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xAAFFFFFF;
    private static final int PRESSED_COLOR = 0xFFFFFFFF;
    private static final int DEFAULT_COLOR = 0xFFEEEEEE;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/hitachi_hip32_arrow.png");
    private static final Identifier BUTTON_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/wl_mwb_up.png");
    private static final Identifier LIGHT_UP_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/hitachi_touch_button_1.png");
    ...
    private static final Identifier LIGHT_DOWN_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/hitachi_touch_button_1.png");
    private static final BooleanProperty UNLOCKED = BooleanProperty.of("unlocked");

    public RenderHitachiVIB192Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB192Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB192Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
