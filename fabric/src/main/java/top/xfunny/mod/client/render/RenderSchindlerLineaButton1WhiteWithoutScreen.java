...
public class RenderSchindlerLineaButton1WhiteWithoutScreen extends BlockEntityRenderer<SchindlerLineaButton1WhiteWithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerLineaButton1WhiteWithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerLineaButton1WhiteWithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerLineaButton1WhiteWithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
