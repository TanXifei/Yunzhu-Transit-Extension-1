...
import top.xfunny.mod.block.HitachiVIB820ButtonLCD;
...
public class RenderHitachiVIB820ButtonLCD extends BlockEntityRenderer<HitachiVIB820ButtonLCD.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    @Override
    public void render(HitachiVIB820ButtonLCD.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB820ButtonLCD.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.5F,
                        0xFF000000);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_820_lcd_display_%d",i));
