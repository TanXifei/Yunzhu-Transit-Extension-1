...
import top.xfunny.mod.block.OtisSPEC90Button2Black;
...
public class RenderOtisSPEC90Button2Black extends BlockEntityRenderer<OtisSPEC90Button2Black.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderOtisSPEC90Button2Black(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(OtisSPEC90Button2Black.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            OtisSPEC90Button2Black.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
