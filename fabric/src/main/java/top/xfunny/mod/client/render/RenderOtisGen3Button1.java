...
import top.xfunny.mod.block.OtisGen3Button1;
...
public class RenderOtisGen3Button1 extends BlockEntityRenderer<OtisGen3Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderOtisGen3Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(OtisGen3Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setPosition(-0.125F, 0.1025F);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            OtisGen3Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        FontList.instance.getFont("otis-gen3-display"),
                        9F,
                        0xFFFFFFFF);
