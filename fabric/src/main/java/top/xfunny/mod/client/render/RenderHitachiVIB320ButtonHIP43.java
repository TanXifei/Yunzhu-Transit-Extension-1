...
import top.xfunny.mod.block.HitachiVIB320ButtonHIP43;
...
public class RenderHitachiVIB320ButtonHIP43 extends BlockEntityRenderer<HitachiVIB320ButtonHIP43.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB320ButtonHIP43(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB320ButtonHIP43.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB320ButtonHIP43.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.5F,
                        0xFFDEF6FF);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_320_hip_43_display_%d", i));
