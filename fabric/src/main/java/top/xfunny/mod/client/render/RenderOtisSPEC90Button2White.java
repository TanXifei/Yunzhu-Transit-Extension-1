...
import top.xfunny.mod.block.OtisSPEC90Button2White;
...
public class RenderOtisSPEC90Button2White extends BlockEntityRenderer<OtisSPEC90Button2White.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderOtisSPEC90Button2White(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(OtisSPEC90Button2White.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            OtisSPEC90Button2White.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
