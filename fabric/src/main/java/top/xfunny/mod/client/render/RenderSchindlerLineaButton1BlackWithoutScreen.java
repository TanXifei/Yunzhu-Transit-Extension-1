...
import top.xfunny.mod.block.SchindlerLineaButton1BlackWithoutScreen;
...
public class RenderSchindlerLineaButton1BlackWithoutScreen extends BlockEntityRenderer<SchindlerLineaButton1BlackWithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerLineaButton1BlackWithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerLineaButton1BlackWithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonDownLight.setButtonSound("schindler_linea_button_1");
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerLineaButton1BlackWithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
