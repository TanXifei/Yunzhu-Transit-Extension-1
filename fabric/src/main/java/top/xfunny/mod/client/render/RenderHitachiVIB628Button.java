...
import top.xfunny.mod.block.HitachiVIB628Button;
...
public class RenderHitachiVIB628Button extends BlockEntityRenderer<HitachiVIB628Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB628Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB628Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB628Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFFF4800);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_628_display_%d_%s", i, blockEntity.getPos2().asLong()));
                ...
                liftArrowView.setMargin(0.48F / 16, 0.75F / 16, 0, -0.3F/16);
