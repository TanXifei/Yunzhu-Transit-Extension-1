...
import top.xfunny.mod.block.OtisSPEC90Button1Black;
...
public class RenderOtisSPEC90Button1Black extends BlockEntityRenderer<OtisSPEC90Button1Black.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/otis_ak11_button_1_black.png");
    ...
    public RenderOtisSPEC90Button1Black(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(OtisSPEC90Button1Black.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            OtisSPEC90Button1Black.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
