...
import top.xfunny.mod.block.MitsubishiMPButton1;
...
public class RenderMitsubishiMPButton1 extends BlockEntityRenderer<MitsubishiMPButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR_UP = 0xFF00CCC7;
    private static final int HOVER_COLOR_DOWN = 0xFFCC1850;
    private static final int PRESSED_COLOR_UP = 0xFF00FFF9;
    private static final int PRESSED_COLOR_DOWN = 0xFFFF3A70;
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_mp_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_mp_button_1_light.png");

    public RenderMitsubishiMPButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMPButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMPButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
