...
public class RenderHitachiVIB221ButtonDotMatrix extends BlockEntityRenderer<HitachiVIB221ButtonDotMatrix.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB221ButtonDotMatrix(Argument dispatcher) {
        super(dispatcher);
    }
