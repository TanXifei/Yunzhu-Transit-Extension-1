...
import top.xfunny.mod.block.HitachiVIB182AButton;
...
public class RenderHitachiVIB182AButton extends BlockEntityRenderer<HitachiVIB182AButton.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB182AButton(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB182AButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB182AButton.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7.5F,
                        0xFFDEF6FF);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_182A_segmented_display_%d", i));
