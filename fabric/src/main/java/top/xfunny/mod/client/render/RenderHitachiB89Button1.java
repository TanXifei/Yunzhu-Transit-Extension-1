...
import top.xfunny.mod.block.HitachiB89Button1;
...
public class RenderHitachiB89Button1 extends BlockEntityRenderer<HitachiB89Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiB89Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiB89Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiB89Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
