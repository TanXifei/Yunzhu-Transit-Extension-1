...
public class RenderKoneMButton1 extends BlockEntityRenderer<KoneMButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderKoneMButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(KoneMButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonDown.setDimension(0.6F / 16);
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("kone_m_button_1_display_%d_%s", i, blockEntity.getPos2().asLong()));
                ...
                liftArrowViewDown.setMargin(0, -0.25F / 16, 0, 1.37F / 16);
