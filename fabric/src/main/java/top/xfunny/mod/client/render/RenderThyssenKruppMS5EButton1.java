...
import top.xfunny.mod.block.ThyssenKruppMS5EButton1;
...
public class RenderThyssenKruppMS5EButton1 extends BlockEntityRenderer<ThyssenKruppMS5EButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/thyssenkrupp_arrow_1_square.png");
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/thyssenkrupp_mt42_button_1.png");
    private static final Identifier LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/thyssenkrupp_mt42_button_1_light.png");
    private static final BooleanProperty UNLOCKED = BooleanProperty.of("unlocked");

    public RenderThyssenKruppMS5EButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ThyssenKruppMS5EButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonUp.setDimension(0.825F / 16);
        ...
        buttonUpLight.setDimension(0.825F / 16);
        ...
        buttonDown.setDimension(0.825F / 16);
        ...
        buttonDownLight.setDimension(0.825F / 16);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ThyssenKruppMS5EButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        blockPos,
                        lift,
                        FontList.instance.getFont("thyssenkrupp-square-dot-matrix"),
                        5F,
                        0xFFCC0000);

                liftFloorDisplayView.setTextureId(String.format("thyssenkrupp_ms5e_button_1_display_%d", i));
                liftFloorDisplayView.setWidth(0.8F / 16);
                liftFloorDisplayView.setHeight(1.7F / 16);

                liftFloorDisplayView.setMargin(0.475F / 16, -0.175F / 16, 0.35F / 16, 0);
                ...
                liftArrowView.setMargin(0.5F/16, 1.87F / 16, 0, 0);
