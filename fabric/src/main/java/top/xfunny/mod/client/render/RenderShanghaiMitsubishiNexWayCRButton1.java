...
import top.xfunny.mod.block.ShanghaiMitsubishiNexWayCRButton1;
...
public class RenderShanghaiMitsubishiNexWayCRButton1 extends BlockEntityRenderer<ShanghaiMitsubishiNexWayCRButton1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/shanghai_mitsubishi_nexway_cr_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/shanghai_mitsubishi_nexway_cr_button_1_light.png");

    public RenderShanghaiMitsubishiNexWayCRButton1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ShanghaiMitsubishiNexWayCRButton1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ShanghaiMitsubishiNexWayCRButton1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_nexway_button_2_display_%d", i))
;
