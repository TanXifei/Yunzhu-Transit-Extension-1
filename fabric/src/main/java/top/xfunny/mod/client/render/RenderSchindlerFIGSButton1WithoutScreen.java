...
public class RenderSchindlerFIGSButton1WithoutScreen extends BlockEntityRenderer<SchindlerFIGSButton1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF009900;
    private static final int PRESSED_COLOR = 0xFF00CC00;
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_d_series_line_d4button.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_d_series_line_d4button_light.png");

    public RenderSchindlerFIGSButton1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerFIGSButton1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setParentDimensions(1.75F / 16, 5F / 16);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSButton1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
