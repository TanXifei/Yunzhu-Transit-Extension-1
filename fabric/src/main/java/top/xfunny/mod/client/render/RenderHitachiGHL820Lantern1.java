...
public class RenderHitachiGHL820Lantern1<T extends LiftButtonsBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier ARROW_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/hitachi_ghl820_arrow.png");
    private final boolean isOdd;

    public RenderHitachiGHL820Lantern1(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        lanternArrowUpLeft.setDimension(1F / 16);
        ...
        lanternArrowUpRight.setDimension(1F / 16);
        ...
        lanternArrowDownLeft.setDimension(1F / 16);
        ...
        lanternArrowDownRight.setDimension(1F / 16);
        ...
        if (buttonDescriptor.hasDownButton() || buttonDescriptor.hasUpButton()) {
            lanternGroupLeft.setMargin(0, 0.875F / 16, 0, 0);
