...
import top.xfunny.mod.block.SchindlerLineaButton2Black;
...
public class RenderSchindlerLineaButton2Black extends BlockEntityRenderer<SchindlerLineaButton2Black.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerLineaButton2Black(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerLineaButton2Black.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerLineaButton2Black.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
