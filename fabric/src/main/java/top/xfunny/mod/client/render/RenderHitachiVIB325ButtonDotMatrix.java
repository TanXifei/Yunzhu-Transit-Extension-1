...
import top.xfunny.mod.block.HitachiVIB325ButtonDotMatrix;
...
public class RenderHitachiVIB325ButtonDotMatrix extends BlockEntityRenderer<HitachiVIB325ButtonDotMatrix.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB325ButtonDotMatrix(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB325ButtonDotMatrix.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB325ButtonDotMatrix.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFFF4800);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_325_dot_matrix_display_%d_%s", i, blockEntity.getPos2().asLong()));
