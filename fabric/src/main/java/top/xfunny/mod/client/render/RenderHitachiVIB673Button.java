...
public class RenderHitachiVIB673Button extends BlockEntityRenderer<HitachiVIB673Button.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderHitachiVIB673Button(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(HitachiVIB673Button.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            HitachiVIB673Button.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        5F,
                        0xFFFF4800);
                liftFloorDisplayView.setTextureId(String.format("hitachi_vib_673_display_%d_%s", i, blockEntity.getPos2().asLong()));
