...
import top.xfunny.mod.block.MitsubishiMaxiezButton2;
...
public class RenderMitsubishiMaxiezButton2 extends BlockEntityRenderer<MitsubishiMaxiezButton2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMaxiezButton2(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        buttonLayout.setMargin(0, 0.6F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMaxiezButton2.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_maxiez_button_2_display_%d_%s", i, blockEntity.getPos2().asLong()));
