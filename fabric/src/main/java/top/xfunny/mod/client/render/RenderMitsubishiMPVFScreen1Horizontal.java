...
public class RenderMitsubishiMPVFScreen1Horizontal<T extends LiftButtonsBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiMPVFScreen1Horizontal(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setPosition(isOdd ? -7.75F / 16 : -15.75F / 16, 8.125F / 16);
        ...
        screenLayout.setMargin(0, 0, 0.45F / 16, 0);
        ...
        lanternGroupLeft.setMargin(0, 0, 0.45F / 16, 0);
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_mpvf_screen_1_horizontal_display_%d_%s", i, blockEntity.getPos2().asLong()));//字体贴图id，不能与其他显示屏的重复
                ...
                liftFloorDisplayView.setMargin(0.6F / 16, -0.1F / 16, 0.8F / 16, 0.5F / 16);
