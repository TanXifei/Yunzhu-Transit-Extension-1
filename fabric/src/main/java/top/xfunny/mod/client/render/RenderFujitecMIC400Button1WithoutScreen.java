...
import top.xfunny.mod.block.FujitecMIC400Button1WithoutScreen;
...
public class RenderFujitecMIC400Button1WithoutScreen extends BlockEntityRenderer<FujitecMIC400Button1WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/fujitec_mic400_button_1_light.png");

    public RenderFujitecMIC400Button1WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(FujitecMIC400Button1WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            FujitecMIC400Button1WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
