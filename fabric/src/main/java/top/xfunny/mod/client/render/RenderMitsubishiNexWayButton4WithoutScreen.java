...
import top.xfunny.mod.block.MitsubishiNexWayButton4WithoutScreen;
...
public class RenderMitsubishiNexWayButton4WithoutScreen extends BlockEntityRenderer<MitsubishiNexWayButton4WithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderMitsubishiNexWayButton4WithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiNexWayButton4WithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiNexWayButton4WithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
