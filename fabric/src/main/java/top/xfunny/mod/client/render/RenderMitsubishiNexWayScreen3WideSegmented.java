...
import top.xfunny.mod.block.MitsubishiNexWayScreen3WideSegmentedEven;
...
public class RenderMitsubishiNexWayScreen3WideSegmented<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderMitsubishiNexWayScreen3WideSegmented(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiNexWayScreen3WideSegmentedEven.LiftCheck(trackPosition, (floorIndex, lift) -> sortedPositionsAndLifts.add(new ObjectObjectImmutablePair<>(trackPosition, lift)));
        });
