...
import top.xfunny.mod.block.SchindlerSSeriesDarkGreyButton;
...
public class RenderSchindlerSSeriesDarkGreyButton extends BlockEntityRenderer<SchindlerSSeriesDarkGreyButton.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF90FF90;
    private static final int PRESSED_COLOR = 0xFF00FF00;
    private static final int DEFAULT_COLOR = 0xFF000000;
    private final Identifier BUTTON_TEXTURE = new Identifier(Init.MOD_ID, "textures/block/schindler_s_series_dark_grey_button.png");
    ...
    private final Identifier LOGO = new Identifier(Init.MOD_ID, "textures/block/schindler_m_series_logo_1_white.png");


    public RenderSchindlerSSeriesDarkGreyButton(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerSSeriesDarkGreyButton.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerSSeriesDarkGreyButton.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
