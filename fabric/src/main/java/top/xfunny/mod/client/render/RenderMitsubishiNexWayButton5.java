...
import top.xfunny.mod.block.MitsubishiNexWayButton5;
...
public class RenderMitsubishiNexWayButton5 extends BlockEntityRenderer<MitsubishiNexWayButton5.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_nexway_button_3.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_nexway_button_3_light.png");

    public RenderMitsubishiNexWayButton5(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiNexWayButton5.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiNexWayButton5.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
