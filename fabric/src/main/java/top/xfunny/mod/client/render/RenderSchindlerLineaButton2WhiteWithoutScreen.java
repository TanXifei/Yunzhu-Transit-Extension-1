...
import top.xfunny.mod.block.SchindlerLineaButton2WhiteWithoutScreen;
...
public class RenderSchindlerLineaButton2WhiteWithoutScreen extends BlockEntityRenderer<SchindlerLineaButton2WhiteWithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderSchindlerLineaButton2WhiteWithoutScreen(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerLineaButton2WhiteWithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        storedMatrixTransformations1.add(graphicsHolder -> {
            ...
            graphicsHolder.translate(0, 0, 7.675F / 16 - SMALL_OFFSET);
        });
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerLineaButton2WhiteWithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
