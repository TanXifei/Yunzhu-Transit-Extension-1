...
import top.xfunny.mod.block.SchindlerLineaScreen2BlackHorizontalEven;
...
public class RenderSchindlerLineaScreen2BlackHorizontal<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderSchindlerLineaScreen2BlackHorizontal(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
    ...
    public void render(T blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerLineaScreen2BlackHorizontalEven.LiftCheck(trackPosition, (floorIndex, lift) -> sortedPositionsAndLifts.add(new ObjectObjectImmutablePair<>(trackPosition, lift)));
        });
...
;
                ...
                liftFloorDisplayView.setMargin(0.6F / 16, 1.125F / 16, 0.1F/16, 0);
                ...
                liftArrowView_left.setMargin(0, 2.05F / 16, 0, 0);
