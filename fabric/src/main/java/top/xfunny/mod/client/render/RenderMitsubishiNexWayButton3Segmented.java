    ...
    public void render(MitsubishiNexWayButton3Segmented.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_nexway_button_3_segmented_display_%d", i));
                ...
                liftArrowView.setWidth(0.8F / 16);
                liftArrowView.setHeight(0.8F / 16);
