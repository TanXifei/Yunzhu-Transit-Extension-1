...
import top.xfunny.mod.block.ShanghaiMitsubishiLehy3Button2;
...
public class RenderShanghaiMitsubishiLehy3Button2 extends BlockEntityRenderer<ShanghaiMitsubishiLehy3Button2.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderShanghaiMitsubishiLehy3Button2(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ShanghaiMitsubishiLehy3Button2.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ShanghaiMitsubishiLehy3Button2.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setTextureId(String.format("shanghai_mitsubishi_lehy_3_button_2_display_%d", i))
;
                ...
                liftArrowView.setColor(0xFFFFEF95);
