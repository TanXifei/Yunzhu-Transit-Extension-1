...
import top.xfunny.mod.block.FujitecMIC400Button1OldWithoutScreen;
...
public class RenderFujitecMIC400Button1OldWithoutScreen extends BlockEntityRenderer<FujitecMIC400Button1OldWithoutScreen.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    @Override
    public void render(FujitecMIC400Button1OldWithoutScreen.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        parentLayout.setParentDimensions(2.35F / 16, 4.8F / 16);
        parentLayout.setPosition(-1.175F / 16, 0.6F / 16);
        ...
        ImageView arrowUp = new ImageView();
        arrowUp.setBasicsAttributes(world, blockPos);
        arrowUp.setTexture(ARROW_TEXTURE_UP);
        arrowUp.setDimension(0.7F / 16);
        arrowUp.setGravity(Gravity.CENTER);
        arrowUp.setLight(light);
        ...
        buttonUpLight.setDefaultColor(0xFF444444);
        ...
        ImageView arrowDown = new ImageView();
        arrowDown.setBasicsAttributes(world, blockPos);
        arrowDown.setTexture(ARROW_TEXTURE_DOWN);
        arrowDown.setDimension(0.7F / 16);
        arrowDown.setGravity(Gravity.CENTER);
        arrowDown.setLight(light);
        ...
        buttonDownLight.setDefaultColor(0xFF444444);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            FujitecMIC400Button1OldWithoutScreen.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
