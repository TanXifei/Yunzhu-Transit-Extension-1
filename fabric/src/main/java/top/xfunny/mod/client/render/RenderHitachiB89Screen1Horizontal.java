...
public class RenderHitachiB89Screen1Horizontal<T extends LiftPanelBase.BlockEntityBase> extends BlockEntityRenderer<T> implements DirectionHelper, IGui, IBlock {
    private final boolean isOdd;

    public RenderHitachiB89Screen1Horizontal(Argument dispatcher, Boolean isOdd) {
        super(dispatcher);
        this.isOdd = isOdd;
    }
...
;
                ...
                liftArrowView_left.setMargin(liftDirection != LiftDirection.NONE ? -3.175F/16 : 0, 6.8F / 16, 0, 0);
