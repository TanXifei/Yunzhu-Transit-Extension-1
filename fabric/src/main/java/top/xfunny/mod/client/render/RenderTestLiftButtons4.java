        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                textView.setBasicsAttributes(world,
                        ...
                        7,
                        0xFFFF0000);
                textView.setTextureId(String.format("test_lift_buttons_speed_display_%d", i));
                ...
                liftFloorDisplayView.setTextureId(String.format("test_lift_buttons_display_%d", i));//字体贴图id，不能与其他显示屏的重复
