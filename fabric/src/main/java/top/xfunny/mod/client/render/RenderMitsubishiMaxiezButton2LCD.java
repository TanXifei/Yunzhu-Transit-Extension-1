...
import top.xfunny.mod.block.MitsubishiMaxiezButton2LCD;
...
public class RenderMitsubishiMaxiezButton2LCD extends BlockEntityRenderer<MitsubishiMaxiezButton2LCD.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFFCCCCCC;
    private static final int PRESSED_COLOR = 0xFFFFFFFF;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_maxiez_2_lcd_arrow_1.png");
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_maxiez_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/mitsubishi_maxiez_button_1_light.png");

    public RenderMitsubishiMaxiezButton2LCD(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(MitsubishiMaxiezButton2LCD.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        storedMatrixTransformations1.add(graphicsHolder -> {
            ...
            graphicsHolder.translate(0, 0, 7.94F / 16 - SMALL_OFFSET);
        });
        ...
        screenLayout.setMargin(0, 1.8F / 16, 0, 0);
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            MitsubishiMaxiezButton2LCD.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        FontList.instance.getFont("mitsubishi_maxiez_lcd_1"),
                        6.75F,
                        0xFFBBBBBB);
                //liftFloorDisplayView.setDisplayLength(2, 0.05F);
                liftFloorDisplayView.setTextureId(String.format("mitsubishi_maxiez_button_2_lcd_display_%d", i));
