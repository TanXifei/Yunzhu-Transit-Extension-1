...
import top.xfunny.mod.block.ThyssenKruppS001Button1;
...
public class RenderThyssenKruppS001Button1 extends BlockEntityRenderer<ThyssenKruppS001Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/thyssenkrupp_arrow_1.png");
    ...
    public RenderThyssenKruppS001Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(ThyssenKruppS001Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            ThyssenKruppS001Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        blockPos,
                        lift,
                        FontList.instance.getFont("thyssenkrupp-round-dot-matrix"),
                        5F,
                        0xFFCC0000);

                liftFloorDisplayView.setTextureId(String.format("thyssenkrupp_s001_button_1_display_%d", i));
                liftFloorDisplayView.setWidth(1.4F / 16);
                liftFloorDisplayView.setHeight(1.7F / 16);

                liftFloorDisplayView.setMargin(0.25F / 16, -0.25F / 16, 0.35F / 16, 0);
