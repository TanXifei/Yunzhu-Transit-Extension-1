...
public class RenderSchindlerFIGSButton1Steel extends BlockEntityRenderer<SchindlerFIGSButton1Steel.BlockEntity> implements DirectionHelper, IGui, IBlock {

    private static final int HOVER_COLOR = 0xFF990000;
    private static final int PRESSED_COLOR = 0xFFFF0000;
    private static final Identifier ARROW_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_arrow_2.png");
    private static final Identifier BUTTON_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_button_1.png");
    private static final Identifier BUTTON_LIGHT_TEXTURE = new Identifier(top.xfunny.mod.Init.MOD_ID, "textures/block/schindler_fi_gs_button_1_light.png");

    public RenderSchindlerFIGSButton1Steel(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(SchindlerFIGSButton1Steel.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            SchindlerFIGSButton1Steel.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
