...
public class RenderDewhurstUS89Button1 extends BlockEntityRenderer<DewhurstUS89Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderDewhurstUS89Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(DewhurstUS89Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            DewhurstUS89Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (buttonDescriptor.hasDownButton()) {
            if (buttonDescriptor.hasUpButton()) {
                downButtonGroup.setMargin(0, 0.6F / 16, 0, 0);
            }
