...
import top.xfunny.mod.block.KoneKDS360Button1;
...
public class RenderKoneKDS360Button1 extends BlockEntityRenderer<KoneKDS360Button1.BlockEntity> implements DirectionHelper, IGui, IBlock {
    ...
    public RenderKoneKDS360Button1(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(KoneKDS360Button1.BlockEntity blockEntity, float tickDelta, GraphicsHolder graphicsHolder1, int light, int overlay) {
        ...
        blockEntity.forEachTrackPosition(trackPosition -> {
            ...
            //判断是否渲染上下按钮
            KoneKDS360Button1.hasButtonsClient(trackPosition, buttonDescriptor, (floorIndex, lift) -> {
        ...
        if (!sortedPositionsAndLifts.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                liftFloorDisplayView.setBasicsAttributes(world,
                        ...
                        7,//字号
                        0xFFFFFFFF);//字体颜色
                liftFloorDisplayView.setTextureId(String.format("kone_kds_360_lcd_segment_display_%d", i));//字体贴图id，不能与其他显示屏的重复
