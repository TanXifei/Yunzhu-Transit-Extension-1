...
public class SchindlerFIGSScreen1BlackEven extends LiftPanelBase {
    public SchindlerFIGSScreen1BlackEven() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new SchindlerFIGSScreen1BlackEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_FI_GS_SCREEN_1_BLACK_EVEN.get(), pos, state);
        }
    }
