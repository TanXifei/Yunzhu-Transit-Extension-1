...
public class MitsubishiNexWayButton3Segmented extends LiftButtonsBase {

    public MitsubishiNexWayButton3Segmented() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(!single ? 6.925 : 6.275, 0.625, 0, !single ? 9.075 : 9.725, 12.375, 0.5, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_BUTTON_3_SEGMENTED.get(), pos, state);
        }
    }
