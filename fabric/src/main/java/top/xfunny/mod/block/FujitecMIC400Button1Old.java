...
public class FujitecMIC400Button1Old extends LiftButtonsBase {

    public FujitecMIC400Button1Old() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(single ? 5.95 : 6.95, 0.6, 0, single ? 10.05 : 9.05, 12.4, 0.05, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.FUJITEC_MIC400_BUTTON_1_OLD.get(), pos, state);
        }
    }
