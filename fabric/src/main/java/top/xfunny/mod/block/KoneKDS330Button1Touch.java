...
public class KoneKDS330Button1Touch extends LiftButtonsBase {
    public KoneKDS330Button1Touch() {
        super(true, true, 0.3);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.KONE_KDS330_BUTTON_1_TOUCH.get(), pos, state);
        }
    }
}
