...
public class SchindlerFIGSScreen1SteelEven extends LiftPanelBase {
    public SchindlerFIGSScreen1SteelEven() {
        super(false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new SchindlerFIGSScreen1SteelEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SCHINDLER_FI_GS_SCREEN_1_STEEL_EVEN.get(), pos, state);
        }
    }
