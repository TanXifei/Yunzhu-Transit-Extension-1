...
public class ThyssenKruppALC01Button1 extends LiftButtonsBase {
    public ThyssenKruppALC01Button1() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new ThyssenKruppALC01Button1.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.THYSSENKRUPP_AL_C01_BUTTON_1.get(), pos, state);
        }
    }
}
