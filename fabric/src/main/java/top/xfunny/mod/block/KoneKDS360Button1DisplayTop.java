...
public class KoneKDS360Button1DisplayTop extends LiftButtonsBase {
    public KoneKDS360Button1DisplayTop() {
        super(true, true, 0.3);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.KONE_KDS360_BUTTON_1_DISPLAY_TOP.get(), pos, state);
        }
    }
}
