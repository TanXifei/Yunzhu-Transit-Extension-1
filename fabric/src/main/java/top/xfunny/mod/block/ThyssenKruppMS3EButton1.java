...
public class ThyssenKruppMS3EButton1 extends LiftButtonsBase {
    public ThyssenKruppMS3EButton1() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new ThyssenKruppMS3EButton1.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.THYSSENKRUPP_MS3E_BUTTON_1.get(), pos, state);
        }
    }
}
