...
public class MitsubishiMaxiezButton2LCD extends LiftButtonsBase {

    public MitsubishiMaxiezButton2LCD() {
        super(true, true);
    }
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return IBlock.getVoxelShapeByDirection(!single ? 6.95 : 6.075, 1.1, 0, !single ? 9.05 : 9.925, 11.48, 0.1, IBlock.getStatePropertySafe(state, FACING));
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_MAXIEZ_BUTTON_2_LCD.get(), pos, state);
        }
    }
