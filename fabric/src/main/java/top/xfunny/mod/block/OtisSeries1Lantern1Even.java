...
public class OtisSeries1Lantern1Even extends LiftButtonsBase {
    public OtisSeries1Lantern1Even() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new OtisSeries1Lantern1Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SERIES_1_LANTERN_1_EVEN.get(), pos, state);
        }
    }
