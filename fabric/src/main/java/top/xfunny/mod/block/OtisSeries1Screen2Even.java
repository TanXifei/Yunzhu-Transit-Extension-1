...
public class OtisSeries1Screen2Even extends LiftButtonsBase {
    public OtisSeries1Screen2Even() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new OtisSeries1Screen2Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SERIES_1_SCREEN_2_EVEN.get(), pos, state);
        }
    }
