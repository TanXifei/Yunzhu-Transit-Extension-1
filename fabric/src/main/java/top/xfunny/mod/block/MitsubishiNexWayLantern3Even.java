...
public class MitsubishiNexWayLantern3Even extends LiftButtonsBase {
    public MitsubishiNexWayLantern3Even() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new MitsubishiNexWayLantern3Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_NEXWAY_LANTERN_3_EVEN.get(), pos, state);
        }
    }
}
