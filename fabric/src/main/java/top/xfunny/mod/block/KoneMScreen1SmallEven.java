...
public class KoneMScreen1SmallEven extends LiftButtonsBase {
    public KoneMScreen1SmallEven() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new KoneMScreen1SmallEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.KONE_M_SCREEN_1_SMALL_EVEN.get(), pos, state);
        }
    }
}
