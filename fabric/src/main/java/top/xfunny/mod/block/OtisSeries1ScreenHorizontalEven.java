...
public class OtisSeries1ScreenHorizontalEven extends LiftButtonsBase {
    public OtisSeries1ScreenHorizontalEven() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new OtisSeries1ScreenHorizontalEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SERIES_1_SCREEN_1_HORIZONTAL_EVEN.get(), pos, state);
        }
    }
