...
public class OtisSeries1Screen2HorizontalEven extends LiftButtonsBase {
    public OtisSeries1Screen2HorizontalEven() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new OtisSeries1Screen2HorizontalEven.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SERIES_1_SCREEN_2_HORIZONTAL_EVEN.get(), pos, state);
        }
    }
