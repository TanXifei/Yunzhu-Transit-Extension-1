...
public class MitsubishiMaxiezButton3 extends LiftButtonsBase {

    public MitsubishiMaxiezButton3() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_MAXIEZ_BUTTON_3.get(), pos, state);
        }
    }
