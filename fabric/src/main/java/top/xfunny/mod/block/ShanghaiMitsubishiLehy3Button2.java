...
public class ShanghaiMitsubishiLehy3Button2 extends LiftButtonsBase {
    public ShanghaiMitsubishiLehy3Button2() {
        super(true, true);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new ShanghaiMitsubishiLehy3Button2.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.SHANGHAI_MITSUBISHI_LEHY_3_BUTTON_2.get(), pos, state);
        }
    }
}
