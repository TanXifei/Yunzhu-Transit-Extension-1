...
public class MitsubishiMaxiezButton2 extends LiftButtonsBase {

    public MitsubishiMaxiezButton2() {
        super(true, true);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.MITSUBISHI_MAXIEZ_BUTTON_2.get(), pos, state);
        }
    }
