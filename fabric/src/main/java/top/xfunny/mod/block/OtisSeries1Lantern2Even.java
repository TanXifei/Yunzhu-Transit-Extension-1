...
public class OtisSeries1Lantern2Even extends LiftButtonsBase {
    public OtisSeries1Lantern2Even() {
        super(false, false);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new OtisSeries1Lantern2Even.BlockEntity(blockPos, blockState);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.OTIS_SERIES_1_LANTERN_2_EVEN.get(), pos, state);
        }
    }
